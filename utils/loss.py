...
class MixSoftmaxCrossEntropyOHEMLoss(SoftmaxCrossEntropyOHEMLoss):
    ...
    def _aux_forward(self, preds, target):
        loss = super(MixSoftmaxCrossEntropyOHEMLoss, self).forward(preds[0], target)  # Change here
        for i in range(1, len(preds)):
    ...
    def forward(self, preds, target):
        if self.aux:
            ...
            return super(MixSoftmaxCrossEntropyOHEMLoss, self).forward(preds[0], target)  # Change here
