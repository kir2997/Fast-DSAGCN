...
from models.fast_dsagcn import get_fast_scnn
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Fast-DSAGCN on PyTorch')
    # model and dataset
    parser.add_argument('--model', type=str, default='FastDSAGCN',
                        help='model name (default: fast_dsagcn, DSANet)')
...
class Trainer(object):
    def __init__(self, args):
        ...
        # create network, , aux=args.aux
        self.model = get_fast_scnn(dataset=args.dataset)
